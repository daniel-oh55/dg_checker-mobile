...
// D1's `wrangler d1 execute --file` import path documents a `Statement too
// long` failure for large single INSERTs, so a production-sized dataset is
// split into bounded, deterministic batches of this size.
